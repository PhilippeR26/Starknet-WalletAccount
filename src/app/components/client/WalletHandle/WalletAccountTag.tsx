...
export default function WalletAccountTag() {
    ...
    const [displayDeployAccountWA, setDisplayDeployAccountWA] = useState<Boolean>(false);
    ...
    const [resultDeployAccountWA, setResultDeployAccountWA] = useState<string>("");
    ...
    const handleDeployAccountWalletAccount = () => {
        let response: string = "N/A";
        ...
        myWalletAccount?.deployAccount({ classHash: accountClass, constructorCalldata: [pubK] })
            ...
            .catch((error: any) => {
                console.log("deploy account error =", error.toString());
                response = error.toString()
            })
            .finally(() => {
                console.log("deploy account finally");
                setDisplayDeployAccountWA(true);
                setResultDeployAccountWA(response);
            });
    }
        ...
        <>
            ...
            >
                ...
                <>
                    ...
                    {displayDeployAccountWA ? (
                        <Box bg='green.200' color='black' borderWidth='1px' borderColor='green.800' borderRadius='md' p={1} marginTop={2}>
                            <Text className={styles.text1}>result : {resultDeployAccountWA}</Text>
                        </Box>
                    ) : null}
                </>
                <>
